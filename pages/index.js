...
const calc = ()=>{
  ...
  return (
    <div className='relative overflow-scroll scrollbar-hide'>
      <h1 className=' italic text-center text-purple-600 font-serif font-bold'>Slaughtering MRP <small className=' font-semibold font-sans text-red-400 text-md'>v2</small><small className='text-sm'> Last Update 29-Aug 13:37 pm</small></h1>
